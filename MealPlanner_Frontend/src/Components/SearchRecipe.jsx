...
<div className="wrap">
   <div className="search">
      <input type="text"   value={query} className="searchTerm"   onChange={(e) => setQuery(e.target.value)} placeholder="What are you looking for?"/>
  ...
  <a target="_blank" href="img_5terre.jpg">
    <img src={recipe.recipe.image} alt={recipe.recipe.label} width="600" height="300px"/>
  </a>
  <p className="card-title">{recipe.recipe.label}</p>
  <button className="card-btn"> <a href={recipe.recipe.url} target="_blank" rel="noopener noreferrer">
